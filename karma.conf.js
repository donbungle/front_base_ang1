...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/indicadores/indicadoresModule.js',
			'app/modules/indicadores/indicadoresCtrl.js',
			'app/modules/indicadores/indicadoresRoute.js',
			'app/modules/indicadores/indicadoresService.js',
			'app/modules/indicadores/indicadores-test.js',
		],
